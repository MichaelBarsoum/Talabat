...
namespace Talabat.Repository.Migrations
{
    ...
    [Migration("20240501192401_CustomizeDeleteBehaviorForDeliveryMethodInOrderEntity")]
    partial class CustomizeDeleteBehaviorForDeliveryMethodInOrderEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Talabat.Core.Models.Order.DeliveryMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talabat.Core.Models.Order.Order", b =>
                {
                    b.HasOne("Talabat.Core.Models.Order.DeliveryMethod", "DeliveryMethod")
                        .WithMany()
                        .HasForeignKey("DeliveryMethodId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.OwnsOne("Talabat.Core.Models.Order.OrderAddress", "ShippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("Talabat.Core.Models.Order.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("Talabat.Core.Models.Order.ProductItemOrdered", "Product", b1 =>
                        {
            ...
            modelBuilder.Entity("Talabat.Core.Models.Product", b =>
                {
                    b.HasOne("Talabat.Core.Models.ProductBrand", "barnd")
                        .WithMany()
